...
import { addCard, deleteCard, updateCard } from '../store/kanbanSlice';
    ...
    <div className="h-full">
      <div className="w-72 rounded-xl overflow-hidden bg-dark-bg p-3 flex-shrink-0">
        <div className="flex items-center justify-between mb-2">
          <h3 className="text-white font-medium px-1">{column.title}</h3>
              ...
              {isMenuOpen && (
                <div ref={menuRef} className="absolute right-0 mt-2 w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5">
                  <div className="py-1" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
                    <div className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 cursor-pointer" onClick={handleAddCard} role="menuitem">Add card...</div>
